		...
		<div class="container">
				<sql:query var="names" dataSource="jdbc/N3CExpertiseTagLib">
					select
						...
						author,
						orcid
					from scholar_profile.citation natural join scholar_profile.authorship natural join scholar_profile.authorship_map
					where ror_id is null
					  and (orcid != 'organization' or orcid is null)
					order by title,seqnum;
				</sql:query>
				<h3>Unbound Authors</h3>
				<table class="table table-striped">
					<tr><th>Act</th><th>Title</th><th>Author</th><th>ORCiD</th><th>ROR Name</th></tr>
					<c:forEach items="${names.rows}" var="row" varStatus="rowCounter">
						<tr>
							<td><a href="lookup_ror_staging.jsp?author=${row.author}">link</a></td>
